...
/**
 * The {@code prod} profile: plain HTTP is redirected to HTTPS, HTTPS responses carry HSTS, the demo
 * user is not seeded, and the console logs ECS JSON. Uses its own in-memory database so the seed
